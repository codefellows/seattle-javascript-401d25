...
import googleSignIn from '../../assets/google-white-sign.png';
...
class Navbar extends React.Component {
  // encodeURIComponent('&scope=openid email profile');
  setGoogleOAuthUrl = () => {
  ...
  renderJSX = (loggedIn) => {
    ...
    <ul>
      ...
      <li><a href={ this.setGoogleOAuthUrl() }><img src={googleSignIn}/></a></li>
    </ul>;
