...
export default (request, response, next) => {
  ...
  // base64AuthHeader is base64 encoded, so we use Node's Buffer class to makea new buffer out of it, inform the Buffer class it should expect a base64-encoded string (hence passing in the 'base64' arg), then we toString() it to convert it utf-8 to human readable form
